...
<div class="center-align center hide-on-med-and-down">
    <ul class="pagination">
        ...
        <li class="waves-effect active"><a href="y.php">Y</a></li>
...
<section class="ss hide-on-med-and-down">
    <?php
    $i = 0;
    $fp = fopen("../definiendo/y.txt", "r") or die('no se pudo conectar');
    while (!feof($fp)) {
        $buffer = fgets($fp, 100);
        $buf[$i] = $buffer;
        $i = $i + 1;
    ...
    <ul class="collapsible" data-collapsible="accordion">
        <li>
            ...
            <div class="collapsible-body">
                <form action="y.php" method="post" enctype="multipart/form-data">
