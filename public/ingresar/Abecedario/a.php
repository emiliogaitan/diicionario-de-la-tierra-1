    ...
    <div class="nav-wrapper z-depth-1 green">
        ...
        <ul class="side-nav" id="mobile-demo">
            ...
            if (!isset($_SESSION['user'])) {
                ...
                ?>
                <li><a href="../../index.php">Cerrar Seccion</a></li>
                <?php
            }
            ?>
            <li>
...
<div class="center-align center hide-on-med-and-down">
    <ul class="pagination">
        ...
        <li class="waves-effect active"><a href="a.php">A</a></li>
...
<section class="ss hide-on-med-and-down">
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/A/Aire/aire/1.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Aire<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Aire<i class="material-icons right">close</i></span>
            <p>Se denomina aire a la mezcla de gases que constituye la atmósfera terrestre, que permanecen alrededor del
                planeta Tierra por acción de la fuerza de gravedad. El aire es esencial para la vida en el planeta. Es
            ...
            <div class="center center-block i">
                <img src="Hackathon/A/Aire/aire/1.jpg" alt="" class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/A/Aire/aire/2.jpg" alt="" class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/A/Aire/aire/3.jpg" alt="" class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/A/Alergenicos/alergenicos/1.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Alergenicos<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Alergenicos<i class="material-icons right">close</i></span>
            <p>Sustancias de origen natural o sintético que aceleran la producción de anticuerpos y producen reacciones
                y síntomas de enfermedad, desde simples inflamaciones hasta shocks que pueden causar la muerte.</p>
            <div class="center center-block i">
                <img src="Hackathon/A/Alergenicos/alergenicos/1.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/A/Alergenicos/alergenicos/2.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/A/Alergenicos/alergenicos/4.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/A/Alergenicos/alergenicos/alergia-alimentaria.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <?php
    $i = 0;
    $fp = fopen("../definiendo/a.txt", "r") or die('no se pudo conectar');
    while (!feof($fp)) {
        $buffer = fgets($fp, 100);
        $buf[$i] = $buffer;
        $i = $i + 1;
...
<section class="ss hide-on-med-and-up">
    ...
    <div class="card">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/A/Asbestos/asbestos/1.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Asbestos<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Asbestos<i class="material-icons right">close</i></span>
            <p>Mineral fibroso muy resistente al calor que se aplica como aislante térmico. Es una sustancia
                cancerígena. Sinónimo: amianto.</p>
            <div class="center center-block i">
                <img src="Hackathon/A/Asbestos/asbestos/1.jpg" alt="" class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/A/Asbestos/asbestos/2.jpg" alt="" class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <?php
