...
<div class="center-align center hide-on-med-and-down">
    <ul class="pagination">
        ...
        <li class="waves-effect active"><a href="k.php">K</a></li>
...
<section class="ss hide-on-med-and-down">
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/K/Karst/karts/karst.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Karst<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Karst<i class="material-icons right">close</i></span>
            <p>Se produce por disolución indirecta del carbonato cálcico de las rocas calizas debido a la acción de
                aguas ligeramente ácidas. Forma de relieve originado por meteorización química de determinadas rocas
                (como la caliza, dolomía, aljez, etc.) compuestas por minerales solubles en agua.</p>
            <div class="center center-block i">
                <img src="Hackathon/K/Karst/karts/karst.jpg" alt="" class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/K/Karst/karts/karts2.jpg" alt="" class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/K/Keystone%20species/keyton%20species/especie.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Keystone species<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Keystone species<i
                        class="material-icons right">close</i></span>
            <p>Especies críticas para la estabilidad y supervivencia de una comunidad.</p>
            <div class="center center-block i">
                <img src="Hackathon/K/Keystone%20species/keyton%20species/especie.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/K/Keystone%20species/keyton%20species/especie2.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/K/Keystone%20species/keyton%20species/especie3.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <?php
    $i = 0;
    $fp = fopen("../definiendo/k.txt", "r") or die('no se pudo conectar');
    while (!feof($fp)) {
        $buffer = fgets($fp, 100);
        $buf[$i] = $buffer;
        $i = $i + 1;
