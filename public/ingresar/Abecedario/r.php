...
<div class="center-align center hide-on-med-and-down">
    <ul class="pagination">
        ...
        <li class="waves-effect active"><a href="r.php">R</a></li>
...
<section class="ss hide-on-med-and-down">
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img"
                 src="Hackathon/R/recapitulacion%20embrionaria/recapitulcion%20embrionaria/recapitulacion%20embrionaria.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Recapitulacion Embrionaria<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Recapitulacion Embrionaria<i class="material-icons right">close</i></span>
            <p>Recapitulacion embrionaria:La teoría de la recapitulación o ley biogenética sostiene que el desarrollo
                embrionario de cada especie (ontogenia) repite completamente la historia evolutiva de dicha especie
                (filogenia). Ernst Haeckel (1834-1919) es el biólogo mejor asociado con esta idea. La teoría no se ha
                sostenido contra el examen.</p>
            <div class="center center-block i">
                <img src="Hackathon/R/recapitulacion%20embrionaria/recapitulcion%20embrionaria/recapitulacion%20embrionaria.jpg"
                     alt="" class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/R/recapitulacion%20embrionaria/recapitulcion%20embrionaria/recapitulacion%20embrionaria2.jpg"
                     alt="" class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/R/Recirculación/recirculacion/recirculacion.png">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Recirculacion<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Recirculacion<i
                        class="material-icons right">close</i></span>
            <p>Recirculación: Conducción de las aguas o lodos tratadas parcial o totalmente,
                desde un punto del proceso hacia una etapa de depuración anterior</p>
            <div class="center center-block i">
                <img src="Hackathon/R/Recirculación/recirculacion/recirculacion.png" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/R/Recirculación/recirculacion/recirculacion2.png" alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/R/Resonancia/resonancia/resonancia.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Resonancia<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Resonancia<i class="material-icons right">close</i></span>
            <p>Resonancia:1. En física, la resonancia es cuando las ondas sonoras hacen que algo más que vibrar en
                armonía con las ondas de sonido originales. 2. En música, se refiere a un tono intenso, el cual puede
                ser un sonido fuerte y profundo.</p>
            <div class="center center-block i">
                <img src="Hackathon/R/Resonancia/resonancia/resonancia.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/R/Resonancia/resonancia/resonancia2.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
        </div
    </div>
...
<section class="ss hide-on-med-and-up">
    ...
    <?php
    $i = 0;
    $fp = fopen("../definiendo/r.txt", "r") or die('no se pudo conectar');
    while (!feof($fp)) {
        $buffer = fgets($fp, 100);
        $buf[$i] = $buffer;
        $i = $i + 1;
