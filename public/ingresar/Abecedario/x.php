...
<div class="center-align center hide-on-med-and-down">
    <ul class="pagination">
        ...
        <li class="waves-effect active"><a href="x.php">x</a></li>
...
<div class="hide-on-med-and-up">
    <ul class="pagination">
        ...
        <li class="waves-effect"><a href="t.php">T</a></li>
        <li class="waves-effect"><a href="u.php">U</a></li>
        <li class="waves-effect"><a href="v.php">X</a></li>
        <li class="waves-effect active"><a href="x.php">X</a></li>
        <li class="waves-effect"><a href="y.php">Y</a></li>
        <li class="waves-effect"><a href="z.php">Z</a></li>
        <hr class="z-depth-3">
...
<section class="ss hide-on-med-and-down">
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/X/Xenotransplante/xenotransplante/r04g97.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Xenotransplante<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Xenotransplante<i
                        class="material-icons right">close</i></span>
            <p>Xenotransplante:
                Los xenotrasplantes son los procedimientos en los que se trasplantan células vivas y tejidos de una
                especie a otra especie. Generalmente, se refiere al caso de prolongar la vida humana trasplantando
                órganos no humanos en humanos. Un ejemplo de xenotrasplantación sería trasplantar el corazón de un
                chimpancé a un ser humano.</p>
            <div class="center center-block i">
                <img src="Hackathon/X/Xenotransplante/xenotransplante/descarga%20(2).jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/X/Xenotransplante/xenotransplante/r04g97.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <?php
    $i = 0;
    $fp = fopen("../definiendo/x.txt", "r") or die('no se pudo conectar');
    while (!feof($fp)) {
        $buffer = fgets($fp, 100);
        $buf[$i] = $buffer;
        $i = $i + 1;
