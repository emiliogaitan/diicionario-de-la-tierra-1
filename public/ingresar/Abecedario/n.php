...
<div class="center-align center hide-on-med-and-down">
    <ul class="pagination">
        ...
        <li class="waves-effect active"><a href="n.php">N</a></li>
...
<section class="ss hide-on-med-and-down">
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/N/Nanofiltración/Nanofiltracion/nanofiltracion.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Nanofiltracion<i class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Nanofiltracion<i
                        class="material-icons right">close</i></span>
            <p>Nanofiltración: Tipo de filtración por membranas que permite la separación de moléculas con un diámetro
                mayor de 1 nm.</p>
            <div class="center center-block i">
                <img src="Hackathon/N/Nanofiltración/Nanofiltracion/nanofiltracion2.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/N/Nanofiltración/Nanofiltracion/nanofiltracion3.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/N/Nanofiltración/Nanofiltracion/nanofiltracion.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/N/Natura%202000/NATURA_2000/descarga.png">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Natura 2000<i class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Natura 2000<i class="material-icons right">close</i></span>
            <p>Natura 2000: Natura 2000 es una red ecológica europea de áreas de conservación de la biodiversidad.
                Consta de Zonas Especiales de Conservación (ZEC), designadas de acuerdo con la Directiva Hábitat, así
                como de Zonas de Especial Protección para las Aves (ZEPA) establecidas en virtud de la Directiva Aves.
                Su finalidad es asegurar la supervivencia a largo plazo de las especies y los hábitats más amenazados de
                Europa, contribuyendo a detener la pérdida de biodiveridad ocasionada por el impacto adverso de las
                actividades humanas. Es el principal instrumento para la conservación de la naturaleza en la Unión
                Europea.
            </p>
            <div class="center center-block i">
                <img src="Hackathon/N/Natura%202000/NATURA_2000/descarga.png" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/N/Natura%202000/NATURA_2000/natura2.0.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/N/Nicho%20Ecológico/nicho%20ecologico/nicho.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Nicho Ecológico<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Nicho Ecológico<i
                        class="material-icons right">close</i></span>
            <p>Nicho Ecológico: Papel funcional que desempeña un organismo en el ecosistema.</p>
            <div class="center center-block i">
                <img src="Hackathon/N/Nicho%20Ecológico/nicho%20ecologico/nicho.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/N/Nicho%20Ecológico/nicho%20ecologico/nicho2.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/N/Nicho%20Ecológico/nicho%20ecologico/nicho3.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <?php
    $i = 0;
    $fp = fopen("../definiendo/n.txt", "r") or die('no se pudo conectar');
    while (!feof($fp)) {
        $buffer = fgets($fp, 100);
        $buf[$i] = $buffer;
        $i = $i + 1;
