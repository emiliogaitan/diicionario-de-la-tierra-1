...
<br>
<div class="center-align hide-on-med-and-down center">
    <ul class="pagination">
        ...
        <li class="waves-effect active"><a href="m.php">M</a></li>
...
<section class="ss hide-on-med-and-down">
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator" src="Hackathon/M/Marismas/marismas/marismas.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Marismas<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Marismas<i class="material-icons right">close</i></span>
            <p>Todo terreno bajo de la zona marítima terrestre o del estuario de un río que se inunda periódicamente en
                las mareas y permanece encharcado hasta que la evaporación consume las aguas.</p>
            <div class="center center-block i">
                <img src="Hackathon/Hackathon/M/Marismas/marismas.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/M/Marismas/marismas/marismas2.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/M/Marismas/marismas/marismas3.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/M/MCA/MCA/mca.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">MCA<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">MCA<i class="material-icons right">close</i></span>
            <p>Máxima concentración aceptada. Valor medio de la concentración de una sustancia medida para una
                exposición de 8 horas al día durante 5 días a la semana.</p>
            <div class="center center-block i">
                <img src="Hackathon/M/MCA/MCA/mca.jpg" alt="" class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/M/MCA/MCA/índice.jpg" alt="" class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/M/Mineralización/mineralizacion/mineralizacion.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Mineralización<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Mineralización<i
                        class="material-icons right">close</i></span>
            <p>Degradación de la materia orgánica a sus componentes inorgánicos elementales.</p>
            <div class="center center-block i">
                <img src="Hackathon/M/Mineralización/mineralizacion/mineralizacion.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/M/Mineralización/mineralizacion/mineralizacion2.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/M/Mineralización/mineralizacion/mineralizacion3.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <?php
    $i = 0;
    $fp = fopen("../definiendo/m.txt", "r") or die('no se pudo conectar');
    while (!feof($fp)) {
        $buffer = fgets($fp, 100);
        $buf[$i] = $buffer;
        $i = $i + 1;
    ...
    <div class="card">
        ...
        <div class="card-reveal black-text left-align">
            ...
            <p>Todo terreno bajo de la zona marítima terrestre o del estuario de un río que se inunda periódicamente en
                las mareas y permanece encharcado hasta que la evaporación consume las aguas.</p>
            <div class="center center-block i">
                <img src="Hackathon/M/Marismas/marismas/marismas.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/M/Marismas/marismas/marismas2.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/M/Marismas/marismas/marismas3.jpg" alt=""
