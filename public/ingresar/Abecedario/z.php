...
<div class="center-align center hide-on-med-and-down">
    <ul class="pagination">
        ...
        <li class="waves-effect active"><a href="z.php">Z</a></li>
...
<section class="ss hide-on-med-and-down">
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/Z/zoologia/zoologia/zoologia.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Zoología<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Zoología<i class="material-icons right">close</i></span>
            <p>Zoologia:
                La zoología es la ciencia que estudia los animales. Este estudio se puede hacer desde varios puntos de
                vista: el genético, el fisiológico, el embriológico, el bioquímico etc.</p>
            <div class="center center-block i">
                <img src="Hackathon/Z/zoologia/zoologia/zoologia.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/Z/zoologia/zoologia/descarga%20(3).jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/Z/zoologia/zoologia/images%20(3).jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <?php
    $i = 0;
    $fp = fopen("../definiendo/z.txt", "r") or die('no se pudo conectar');
    while (!feof($fp)) {
        $buffer = fgets($fp, 100);
        $buf[$i] = $buffer;
        $i = $i + 1;
...
<section class="ss hide-on-med-and-up">
    <div class="card">
        ...
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Zoloogia<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
    ...
    <ul class="collapsible" data-collapsible="accordion">
        <li>
            ...
            <div class="collapsible-body">
                <form action="z.php" method="post" enctype="multipart/form-data">
                    ...
                    <input type="text" name="comentario" placeholder="Significado" required="">
                    <p>Imagen:</p>
                    <div>
