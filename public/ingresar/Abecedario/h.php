...
<div class="center-align center hide-on-med-and-down">
    <ul class="pagination">
        ...
        <li class="waves-effect active"><a href="h.php">H</a></li>
...
<section class="ss hide-on-med-and-down">
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/H/Hacking/hacking/hacking.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Hacking<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Hacking<i class="material-icons right">close</i></span>
            <p>Método usado para la reintroducción de una especie en su medio natural. Este sistema consiste en colocar
                los ejemplares en nichos artificiales para llevar a cabo su cría en el propio campo hasta que son
                capaces de volar y alimentarse de forma independiente.</p>
            <div class="center center-block i">
                <img src="Hackathon/H/Hacking/hacking/hacking.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/H/Hacking/hacking/hacking2.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/H/Hacking/hacking/hacking3.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/H/Hidrogenación/hidrogenacion/hidrogenacion.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Hidrogenacion<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Hidrogenacion<i
                        class="material-icons right">close</i></span>
            <p>Combinación química del hidrógeno con otra sustancia, con la acción del calor, la presión y un
                catalizador. Este procedimiento se usa en la industria del petróleo.</p>
            <div class="center center-block i">
                <img src="Hackathon/H/Hidrogenación/hidrogenacion/hidrogenacion.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/H/Hidrogenación/hidrogenacion/hidrogenacion2.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/H/Humus/Humus/Humus.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Humus<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Humus<i class="material-icons right">close</i></span>
            <p>Materia orgánica originada de la degradación de la materia viva, principalmente la vegetal; se
                caracteriza por su gran estabilidad y mineralización lenta.</p>
            <div class="center center-block i">
                <img src="Hackathon/H/Humus/Humus/Humus.jpg" alt="" class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/H/Humus/Humus/humus2.jpg" alt="" class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <?php
    $i = 0;
    $fp = fopen("../definiendo/h.txt", "r") or die('no se pudo conectar');
    while (!feof($fp)) {
        $buffer = fgets($fp, 100);
        $buf[$i] = $buffer;
        $i = $i + 1;
