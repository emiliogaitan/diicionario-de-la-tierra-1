...
<div class="center-align center hide-on-med-and-down">
    <ul class="pagination">
        ...
        <li class="waves-effect active"><a href="g.php">G</a></li>
...
<section class="ss hide-on-med-and-down">
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/G/Gestión%20Ambiental/Gestion%20ambiental/gestion.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Gestion Ambiental<i class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Gestion Ambiental<i class="material-icons right">close</i></span>
            <p>Medidas adoptadas por una empresa o cualquier entidad, encaminadas a disminuir la influencia negativa
                sobre el medio ambiente de sus actividades.</p>
            <div class="center center-block i">
                <img src="Hackathon/G/Gestión%20Ambiental/Gestion%20ambiental/gestion2.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/G/Gestión%20Ambiental/Gestion%20ambiental/gestion3.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/G/Gestión%20Ambiental/Gestion%20ambiental/gestion.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/G/Glider/Glider/glider.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Glider<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Glider<i class="material-icons right">close</i></span>
            <p>Un planeador submarino (en inglés Underwater Glider) es un tipo de Vehículo Autónomo Submarino o AUV (en
                inglés Autonomous Underwater Vehicle) que mediante pequeños cambios de su flotabilidad y utilizando unas
                alas, permite convertir el movimiento vertical en horizontal, obteniendo así un sistema de propulsión de
                muy bajo consumo.</p>
            <div class="center center-block i">
                <img src="Hackathon/G/Glider/Glider/glider.jpg" alt="" class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/G/Glider/Glider/glider2.jpg" alt="" class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/G/Glider/Glider/glider3.jpg" alt="" class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img"
                 src="Hackathon/G/Gotículas%20de%20Flügge/Goticulas%20de%20Flugge/goticulas.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Gotículas de Flügge<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Gotículas de Flügge<i
                        class="material-icons right">close</i></span>
            <p>Son partículas líquidas que transportan agentes infecciosos, fueron descritas por el bacterologista
                alemán Carl Flügge (1847-1923).</p>
            <div class="center center-block i">
                <img src="Hackathon/G/Gotículas%20de%20Flügge/Goticulas%20de%20Flugge/goticulas2.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <?php
    $i = 0;
    $fp = fopen("../definiendo/g.txt", "r") or die('no se pudo conectar');
    while (!feof($fp)) {
        $buffer = fgets($fp, 100);
        $buf[$i] = $buffer;
        $i = $i + 1;
