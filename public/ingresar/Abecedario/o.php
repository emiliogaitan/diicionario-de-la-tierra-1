...
<div class="center-align center hide-on-med-and-down">
    <ul class="pagination">
        ...
        <li class="waves-effect active"><a href="o.php">O</a></li>
...
<section class="ss hide-on-med-and-down">
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/O/O3/O3/O3.2.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">O3<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">O3<i class="material-icons right">close</i></span>
            <p>O3: Símbolo de Ozono, es un gas muy irritante de las vías respiratorias, integra el Smog,
                tiene también propiedades bactericidas y capta la radiación ultravioleta.</p>
            <div class="center center-block i">
                <img src="Hackathon/O/O3/O3/O3.2.jpg" alt="" class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/O/O3/O3/O3.jpg" alt="" class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/O/Oleosa/Oleosa/oleosa.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Oleosa<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Oleosa<i class="material-icons right">close</i></span>
            <p>Oleosa: Aspecto del agua producido por una delgada película aceitosa que se presenta en la superficie de
                las aguas contaminadas
                por aguas negras y aguas residuales con restos aceitosos, etc.</p>
            <div class="center center-block i">
                <img src="Hackathon/O/Oleosa/Oleosa/oleosa.jpg" alt="" class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/O/Oleosa/Oleosa/oleosa2.jpg" alt="" class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img"
                 src="Hackathon/O/Ordenación%20del%20Territorio/Odenacion%20del%20territorio/ordenamento.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Ordenación del Territorio<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Ordenación del Territorio<i class="material-icons right">close</i></span>
            <p>Ordenación del Territorio:La ordenación del Territorio, u Ordenación territorial es una disciplina
                científica, y técnica administrativa;
                influida por multitud de disciplinas; especialmente por la Geografía física, la Geografía humana y
                las Ciencias Ambientales que tienen como objetivo una ocupación racional del territorio,
                mediante la aplicación de normativa que permita o prohíba unos determinados usos de la tierra.</p>
            <div class="center center-block i">
                <img src="Hackathon/O/Ordenación%20del%20Territorio/Odenacion%20del%20territorio/ordenamento.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/O/Ordenación%20del%20Territorio/Odenacion%20del%20territorio/ordenamento2.jpg"
    ...
    <?php
    $i = 0;
    $fp = fopen("../definiendo/o.txt", "r") or die('no se pudo conectar');
    while (!feof($fp)) {
        $buffer = fgets($fp, 100);
        $buf[$i] = $buffer;
        $i = $i + 1;
