...
<div class="center-align center hide-on-med-and-down">
    <ul class="pagination">
        ...
        <li class="waves-effect active"><a href="s.php">S</a></li>
...
<section class="ss hide-on-med-and-down">
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator  responsive-img" src="Hackathon/S/sedimentario/sedimentaio/sedimentario.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Sedimentario<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Sedimentario<i
                        class="material-icons right">close</i></span>
            <p>Sedimentario/a:En geología, lo que es sedimentario, se relaciona a la formación por medio de la cual se
                establecen los sedimentos, tanto orgánicos como inorgánicos, generalmente por el movimiento del agua y
                por el viento, en los que las capas de sedimento se compactan y obtienen un estado sólido, muy duro.</p>
            <div class="center center-block i">
                <img src="Hackathon/S/sedimentario/sedimentaio/sedimentario.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/S/sedimentario/sedimentaio/sedimentario2.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/S/simbiosis/simbiosis/simbiosis.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Simbiosis<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Simbiosis<i class="material-icons right">close</i></span>
            <p>Simbiosis: En biología, la simbiosis, ocurre cuando dos o más organismos de especies diferentes viven
                juntos y se benefician entre sí; aunque el beneficio mutuo no es siempre el caso. Por ejemplo, en los
                humanos pueden existir bacterias que viven en el tracto intestinal y que ayudan a la digestión.</p>
            <div class="center center-block i">
                <img src="Hackathon/S/simbiosis/simbiosis/simbiosis.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/S/simbiosis/simbiosis/simbiosis2.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/S/simbiosis/simbiosis/simbiosis3.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/S/subatomico/subatomico/subatomico.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Subatomico<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Subatomico<i class="material-icons right">close</i></span>
            <p>Subatomico:Aquello que es subatómico es más pequeño que un átomo, tales como las partes de átomos que
                incluyen los protones, los neutrones y los electrones.</p>
            <div class="center center-block i">
                <img src="Hackathon/S/subatomico/subatomico/subatomico1.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <?php
    $i = 0;
    $fp = fopen("../definiendo/s.txt", "r") or die('no se pudo conectar');
    while (!feof($fp)) {
        $buffer = fgets($fp, 100);
        $buf[$i] = $buffer;
        $i = $i + 1;
    ...
    <ul class="collapsible" data-collapsible="accordion">
        <li>
            ...
            <div class="collapsible-body">
                <form action="s.php" method="post" enctype="multipart/form-data" required="">
