...
<div class="center-align center hide-on-med-and-down">
    <ul class="pagination">
        ...
        <li class="waves-effect active"><a href="l.php">L</a></li>
...
<section class="ss hide-on-med-and-down">
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/L/Lahar/lahar/lahar.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Lahar<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Lahar<i class="material-icons right">close</i></span>
            <p>Un lahar (en inglés mudflows o flujos de lodo) es un flujo de barro que se moviliza desde las laderas de
                los estratovolcanes. Durante los últimos siglos, los lahares han destruido más propiedad pública o
                privada que cualquier proceso volcánico y han sido los causantes de la pérdidas de miles de vidas
                humanas. Los lahares, junto con la caída de tefra, son la principal causa de riesgo asociado a
                volcanes.</p>
            <div class="center center-block i">
                <img src="Hackathon/L/Lahar/lahar/lahar.jpg" alt="" class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/L/Lahar/lahar/lahar2.jpg" alt="" class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/L/Lahar/lahar/lahar3.jpg" alt="" class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator  responsive-img" src="Hackathon/L/Limnología/limnologia/limnologia.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Limnología<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Limnología<i class="material-icons right">close</i></span>
            <p>Ciencia que estudia los lagos y lagunas, y por extensión las aguas dulces o continentales. La Limnología
                trata de todos los factores de las aguas quietas o leníticas.</p>
            <div class="center center-block i">
                <img src="Hackathon/L/Limnología/limnologia/limnologia.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/L/Limnología/limnologia/limnologia2.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/L/Limnología/limnologia/limnologia3.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/L/Lluvia%20Ácida/Lluvia%20Acida/lluvia.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Lluvia Ácida<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Lluvia Ácida<i
                        class="material-icons right">close</i></span>
            <p>Lluvia que contiene ácidos disueltos y que por tanto supone una acidificación del medio ambiente. Las
                sustancias más importantes causantes de lluvia ácida pueden recorrer miles de kilómetros antes de
                precipitarse</p>
            <div class="center center-block i">
                <img src="Hackathon/L/Lluvia%20Ácida/Lluvia%20Acida/lluvia.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/L/Lluvia%20Ácida/Lluvia%20Acida/lluvia2.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/L/Lluvia%20Ácida/Lluvia%20Acida/lluvia3.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <?php
    $i = 0;
    $fp = fopen("../definiendo/i.txt", "r") or die('no se pudo conectar');
    while (!feof($fp)) {
        $buffer = fgets($fp, 100);
        $buf[$i] = $buffer;
        $i = $i + 1;
