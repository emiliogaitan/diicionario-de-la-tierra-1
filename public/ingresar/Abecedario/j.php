...
<div class="center-align center hide-on-med-and-down">
    <ul class="pagination">
        ...
        <li class="waves-effect active"><a href="j.php">J</a></li>
...
<section class="ss hide-on-med-and-down">
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/J/Jardín/jardin/jardin.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Jardín<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Jardín<i class="material-icons right">close</i></span>
            <p>Terreno, generalmente cercado, donde se cultivan flores, árboles de sombra o adorno, etc., para fines
                ornamentales, comerciales y educativo.</p>
            <div class="center center-block i">
                <img src="Hackathon/J/Jardín/jardin/jardin.jpg" alt="" class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/J/Jardín/jardin/jardin2.jpg" alt="" class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/J/Jardín%20botánico/jardin%20botanico/boatnico.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Jardín botánico<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Jardín botánico<i
                        class="material-icons right">close</i></span>
            <p>Espacios destinados al cultivo de plantas con un fin científico o divulgativo.</p>
            <div class="center center-block i">
                <img src="Hackathon/J/Jardín%20botánico/jardin%20botanico/boatnico.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/J/Jardín%20botánico/jardin%20botanico/botanico2.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/J/Jardín%20botánico/jardin%20botanico/botanico3.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img"
                 src="Hackathon/J/Justicia%20ambiental/justicia%20ambiental/justicia.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Justicia Ambienta<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Justicia Ambienta<i class="material-icons right">close</i></span>
            <p>Tratamiento justo y la participación significativa de todas las personas independientemente de su raza,
                color, origen nacional, cultura, educación o ingreso con respecto al desarrollo, implantación,
                aplicación de las leyes, reglamentos y políticas ambientales.</p>
            <div class="center center-block i">
                <img src="Hackathon/J/Justicia%20ambiental/justicia%20ambiental/justicia.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/J/Justicia%20ambiental/justicia%20ambiental/justicia2.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/J/Justicia%20ambiental/justicia%20ambiental/justicia3.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <?php
    $i = 0;
    $fp = fopen("../definiendo/j.txt", "r") or die('no se pudo conectar');
    while (!feof($fp)) {
        $buffer = fgets($fp, 100);
        $buf[$i] = $buffer;
        $i = $i + 1;
