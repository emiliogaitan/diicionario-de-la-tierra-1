...
<div class="center-align center hide-on-med-and-down">
    <ul class="pagination">
        ...
        <li class="waves-effect active"><a href="f.php">F</a></li>
...
<section class="ss hide-on-med-and-down">
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator  responsive-img"
                 src="Hackathon/F/Factor%20de%20Dilución/Factor%20dilucion/dilucion1.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Factor de Dilución<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Factor de Dilución<i class="material-icons right">close</i></span>
            <p>Relación entre el volumen (flujo o gasto) de agua de una corriente o cuerpo receptor, con el volumen
                (flujo o gasto) del desecho vertido en aquella.</p>
            <div class="center">
                <img src="Hackathon/F/Factor%20de%20Dilución/Factor%20dilucion/dilucion1.jpg" alt=""
                     class="responsive-img materialboxed">
                <img src="Hackathon/F/Factor%20de%20Dilución/Factor%20dilucion/dilucion2.jpg" alt=""
                     class="responsive-img materialboxed">
            </div>
        </div>
    </div>
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator  responsive-img" src="Hackathon/F/Fauna/fauna/fauna.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Fauna<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Fauna<i class="material-icons right">close</i></span>
            <p>Conjunto de especies animales que viven en un determinado lugar. La que corresponde a un ecosistema
                concreto se la denomina zoocenosis.</p>
            <div class="center center-block i">
                <img src="Hackathon/F/Fauna/fauna/fauna.jpg" alt="" class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/F/Fauna/fauna/fauna.jpg" alt="" class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/F/Fósil/fosil/fosil.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Fosíl<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Fosíl<i class="material-icons right">close</i></span>
            <p>Los fósiles (del latín fossile, lo que se extrae de la tierra) son los restos o señales de la actividad
                de organismos pasados. Dichos restos, conservados en las rocas sedimentarias, pueden haber sufrido
                transformaciones en su composición (por diagénesis) o deformaciones (por metamorfismo dinámico) más o
                menos intensas. La ciencia que se ocupa del estudio de los fósiles es la Paleontología.</p>
            <div class="center center-block i">
                <img src="Hackathon/F/Fósil/fosil/fosil.jpg" alt="" class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <?php
    $i = 0;
    $fp = fopen("../definiendo/f.txt", "r") or die('no se pudo conectar');
    while (!feof($fp)) {
        $buffer = fgets($fp, 100);
        $buf[$i] = $buffer;
        $i = $i + 1;
...
<section class="ss hide-on-med-and-up">
    ...
    <div class="card">
        ...
        <div class="card-reveal black-text left-align">
            ...
            <div class="center center-block i">
                <img src="Hackathon/F/Fósil/fosil/fosil.jpg" alt="" class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/F/Fósil/fosil/fosil2.jpg" alt="" class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/F/Fósil/fosil/fosil3.jpg" alt="" class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <?php
