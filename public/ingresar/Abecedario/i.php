...
<div class="center-align center hide-on-med-and-down">
    <ul class="pagination">
        ...
        <li class="waves-effect active"><a href="i.php">I</a></li>
...
<section class="ss hide-on-med-and-down">
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/I/Impactación/impactacion/impactacion.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Impactación<i class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Impactación<i class="material-icons right">close</i></span>
            <p>Impactacion:Mecanismo por el cual pequeñas partículas (aerosoles) son eliminadas de la atmósfera,
                principalmente por cambio del flujo de aire.</p>
            <div class="center center-block i">
                <img src="Hackathon/I/Impactación/impactacion/impactacion.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/I/Impactación/impactacion/descarga.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/I/Infiltración/infiltracion/inflitracion.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Infiltración<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Infiltración<i
                        class="material-icons right">close</i></span>
            <p>Infilracion:Penetración del agua en el suelo por grietas y poros. También, las corrientes descendentes de
                las aguas subterráneas.</p>
            <div class="center center-block i">
                <img src="Hackathon/I/Infiltración/infiltracion/inflitracion.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/I/Infiltración/infiltracion/inflitracion2.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/I/Inhibición/inhibicion/inhibicion.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Inhibición<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Inhibición<i class="material-icons right">close</i></span>
            <p>Efecto de frenado o parada de una reacción o proceso, ya sea química o bioquímica, por la acción de algún
                agente externo.</p>
            <div class="center center-block i">
                <img src="Hackathon/I/Inhibición/inhibicion/inhibicion2.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/I/Inhibición/inhibicion/inhibicion.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
