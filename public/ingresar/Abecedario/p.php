...
<div class="center-align center hide-on-med-and-down">
    <ul class="pagination">
        ...
        <li class="waves-effect active"><a href="p.php">P</a></li>
...
<section class="ss hide-on-med-and-down">
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/P/PAH/PAH/PAH.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">PAH<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">PAH<i class="material-icons right">close</i></span>
            <p>PAH: Siglas en inglés de los hidrocarburos aromáticos policíclicos.
                Se usan como aditivos para gasolinas sin plomo, solventes, etc.
                Se les atribuyen acciones cancerígenas.</p>
            <div class="center center-block i">
                <img src="Hackathon/P/PAH/PAH/PAH.jpg" alt="" class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/P/PAH/PAH/PAH2.jpg" alt="" class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/P/Partenogénesis/partenogenesis/partenogenesis.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Partenogénesis<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Partenogénesis<i
                        class="material-icons right">close</i></span>
            <p>Partenogénesis: La partenogénesis (del griego parthenos = virgen + ???es?? génesis = generación) es una
                forma de reproducción
                basada en el desarrollo de células sexuales femeninas no fecundadas, que se da con cierta frecuencia en
                platelmintos,
                rotíferos, tardógrados, crustáceos, insectos, anfibios y reptiles, más raramente en algunos peces y,
                excepcionalmente en aves.</p>
            <div class="center center-block i">
                <img src="Hackathon/P/Partenogénesis/partenogenesis/partenogenesis.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/P/Partenogénesis/partenogenesis/partenogenesis2.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/P/PGOU/PGOU/PGOU.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">PGOU<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">PGOU<i class="material-icons right">close</i></span>
            <p>PGOU:El Plan General de Ordenación Urbana, (P.G.O.U.), es un instrumento de planeamiento general definido
                en la normativa
                urbanística de España como un instrumento básico de ordenación integral del territorio de uno o varios
                municipios,
                a través del cual se clasifica el suelo, se determina el régimen aplicable a cada clase de suelo,
                y se definen los elementos fundamentales del sistema de equipamientos del municipio en cuestión.</p>
            <div class="center center-block i">
                <img src="Hackathon/P/PGOU/PGOU/PGOU.jpg" alt="" class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/P/PGOU/PGOU/PGOU2.jpg" alt="" class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <?php
    $i = 0;
    $fp = fopen("../definiendo/p.txt", "r") or die('no se pudo conectar');
    while (!feof($fp)) {
        $buffer = fgets($fp, 100);
        $buf[$i] = $buffer;
        $i = $i + 1;
