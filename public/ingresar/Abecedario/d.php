...
<div class="center-align center hide-on-med-and-down">
    <ul class="pagination">
        ...
        <li class="waves-effect active"><a href="d.php">D</a></li>
...
<section class="ss hide-on-med-and-down">
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img"
                 src="Hackathon/D/Deposición%20seca/Deposición%20seca/350px-Movilidad.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Deposición seca<i class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Deposición seca<i
                        class="material-icons right">close</i></span>
            <p>Sedimentación de partículas presentes en el aire por acción de la gravedad.</p>
            <p>Cuando se vierte una sustancia contaminante al medio ambiente, ésta no permanece en el lugar donde se
                realiza el vertido sino que se produce su dispersión, pues se da toda una serie de fenómenos físicos,
                químicos y biológicos que provocan tanto el transporte dentro de un mismo compartimento ambiental como
                el paso al resto. Los compartimentos ambientales en los que puede dispersarse una sustancia son
                hidrosfera, suelo, atmósfera y biota (plantas y animales).</p>
            <div class="center center-block i">
                <img src="Hackathon/D/Deposición%20seca/Deposición%20seca/350px-Movilidad.jpg"
                     alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/D/Deposición%20seca/Deposición%20seca/350px-Movilidad%20(1).jpg"
                     alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    ...
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img"
                 src="Hackathon/D/Descarbonatación/Descarbonatación/osmosis-y-osmosis-inversa-32-638.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Descarbonatación<i class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Descarbonatación<i
                        class="material-icons right">close</i></span>
            <p>Corrosión de un compuesto que contiene carbonatos al ser atacado por un ácido que los disuelve.</p>
            <p>El intercambio iónico se realiza hasta que el bicarbonato presente se ha convertido en CO2. A partir de
                este momento el H+ que se libera ya no se neutraliza, con lo cual se produce un descenso del valor del
                pH del agua y la resina pierde su capacidad de intercambio. Una vez agotada, la resina se regenera con
                un ácido mineral.</p>
            <p></p>
            <div class="center center-block i">
                <img src="Hackathon/D/Descarbonatación/Descarbonatación/osmosis-y-osmosis-inversa-32-638.jpg"
                     alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    ...
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img"
                 src="Hackathon/D/Distróficas/Distróficas/3.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Distróficas<i class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Distróficas<i
                        class="material-icons right">close</i></span>
            <p>Se llama así a un agua pobre en calcio y nutrientes vegetales. Se caracteriza por tener pH ácido, con
                escasa presencia de vegetación.</p>
            <div class="center center-block i">
                <img src="Hackathon/D/Distróficas/Distróficas/3.jpg"
                <img src="Hackathon/D/Distróficas/Distróficas/2.gif"
                <img src="Hackathon/D/Distróficas/Distróficas/3.jpg"
                     alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
    ...
    <?php
    $i = 0;
    $fp = fopen("../definiendo/d.txt", "r") or die('no se pudo conectar');
    while (!feof($fp)) {
        $buffer = fgets($fp, 100);
        $buf[$i] = $buffer;
        $i = $i + 1;
...
<section class="ss hide-on-med-and-up">
    ...
    <div class="card">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img"
                 src="Hackathon/D/Distróficas/Distróficas/1.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Distróficas<i class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        ...
        <div class="card-reveal black-text left-align">
            ...
            <p>Se llama así a un agua pobre en calcio y nutrientes vegetales. Se caracteriza por tener pH ácido, con
                escasa presencia de vegetación.</p>
            <div class="center center-block i">
                <img src="Hackathon/D/Distróficas/Distróficas/1.jpg"
                <img src="Hackathon/D/Distróficas/Distróficas/2.jpg"
                <img src="Hackathon/D/Distróficas/Distróficas/3.jpg"
                     alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
