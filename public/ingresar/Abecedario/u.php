...
<div class="center-align center">
    <ul class="pagination">
        ...
        <li class="waves-effect active"><a href="u.php">U</a></li>
...
<section class="ss hide-on-med-and-down">
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/U/Unicelular/Unicelular/organismos-unicelulares.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Unicelular<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Unicelular<i class="material-icons right">close</i></span>
            <p>Unicelular: una sola célula. Los organismos unicelulares son organismos completos que tienen una sola
                célula y tienen tamaños microscópicos. Ejemplos de organismos unicelulares serían las bacterias, los
                protozoos y las algas. </p>
            <div class="center center-block i">
                <img src="Hackathon/U/Unicelular/Unicelular/435915cg001.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/U/Unicelular/Unicelular/maxresdefault.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/U/Unicelular/Unicelular/organismos-unicelulares.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img"
                 src="Hackathon/U/Universo%20paralelo/universo%20paralelo/universo.gif">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Universo Paralelo<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Universo Paralelo<i class="material-icons right">close</i></span>
            <p>Universo Paralelo;
                Un universo paralelo es un universo teórico que refleja nuestro universo; donde todo lo que ocurre en
                este, ocurre en el universo paralelo pero de forma opuesta.</p>
            <div class="center center-block i">
                <img src="Hackathon/U/Universo%20paralelo/universo%20paralelo/universo.gif" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/U/Universo%20paralelo/universo%20paralelo/images%20(1).jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/U/Universo%20paralelo/universo%20paralelo/maxresdefault%20(1).jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <?php
    $i = 0;
    $fp = fopen("../definiendo/u.txt", "r") or die('no se pudo conectar');
    while (!feof($fp)) {
        $buffer = fgets($fp, 100);
        $buf[$i] = $buffer;
        $i = $i + 1;
