...
<div class="center-align center hide-on-med-and-down">
    <ul class="pagination">
        ...
        <li class="waves-effect active"><a href="b.php">B</a></li>
...
<section class="ss hide-on-med-and-down">
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/B/Batimetría/Batimetria/1.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Batimetria<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Batimetria<i class="material-icons right">close</i></span>
            <p>Batimetría es el equivalente submarino de la altimetría. En otras palabras, la batimetría es el estudio
                de la profundidad marina, de la tercera dimensión de los fondos lacustres o marinos. Un mapa o carta
                batimétrico normalmente muestra el relieve del fondo o terreno como isógramas, y puede también dar
                información adicional de navegación en superficie.</p>
            <div class="center center-block i">
                <img src="Hackathon/B/Batimetría/Batimetria/1.jpg" alt=""
    ...
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/B/Benozpireno/benozpireno/1.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Benzopireno<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Benzopireno<i class="material-icons right">close</i></span>
            <p>Sustancia cancerígena presente en breas de carbón y en humo del tabaco.</p>
            <div class="center center-block i">
                <img src="Hackathon/B/Benozpireno/benozpireno/1.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/B/Benozpireno/benozpireno/2.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img" src="Hackathon/B/Biota/biota/1.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Biota<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Biota<i class="material-icons right">close</i></span>
            <p>Conjunto de la flora y la fauna de un lugar determinado.</p>
            <p>Para otros usos de este término, véase Biota (desambiguación).</p>
            <p>Para material biológico o biomaterial, véase material biológico.
                En su uso más habitual, mediante el término biotico se designa al conjunto de especies de plantas,
                animales y otros organismos que ocupan un área dada. Se dice, por ejemplo, biota europea para referirse
                a la lista de especies que habitan en ese territorio. El término puede desglosarse en flora y en fauna,
                según los límites establecidos en botánica y en zoología.</p>

            <p>El concepto puede extenderse para designar al repertorio de especies de un compartimento del ecosistema,
                como el suelo, la rizosfera o el fondo de un ecosistema acuático.</p>

            <p>Biota no es lo mismo que biocenosis. La descripción de biota contiene un repertorio. La correspondiente
                a biocenosis debe comprender otros conceptos de la diversidad, relativos a organización y a riqueza
                específica. Por la misma razón se debe no considerar equivalentes las expresiones biosfera y «biota
                terrestre».</p>
            <div class="center center-block i">
                <img src="Hackathon/B/Biota/biota/1.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/B/Biota/biota/2.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/B/Biota/biota/1.jpg" alt="" class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <?php
    $i = 0;
    $fp = fopen("../definiendo/b.txt", "r") or die('no se pudo conectar');
    while (!feof($fp)) {
        $buffer = fgets($fp, 100);
        $buf[$i] = $buffer;
        $i = $i + 1;
...
<section class="ss hide-on-med-and-up">
    <div class="card">
        ...
        <div class="card-reveal black-text left-align">
            ...
            <p>Batimetría es el equivalente submarino de la altimetría. En otras palabras, la batimetría es el estudio
                de la profundidad marina, de la tercera dimensión de los fondos lacustres o marinos. Un mapa o carta
                batimétrico normalmente muestra el relieve del fondo o terreno como isógramas, y pude también dar
                información adicional de navegación en superficie.</p>
            <div class="center center-block i">
                <img src="Hackathon/B/Batimetría/Batimetria/1.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
