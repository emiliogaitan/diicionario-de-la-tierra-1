...
<div class="center-align center hide-on-med-and-down">
    <ul class="pagination">
        ...
        <li class="waves-effect active"><a href="t.php">T</a></li>
...
<section class="ss hide-on-med-and-down">
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img"
                 src="Hackathon/T/Taxonomia/taxonomia/clasificacion-de-los-seres-vivos-taxonomia-13-728.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Taxonomia<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Taxonomia<i class="material-icons right">close</i></span>
            <p>Taxonomia:La ciencia ha ayudado grandemente, a la humanidad, a través de su explicación lógica del mundo.
            ...
            <div class="center center-block i">
                <img src="Hackathon/T/Taxonomia/taxonomia/clasificacion-de-los-seres-vivos-taxonomia-13-728.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/T/Taxonomia/taxonomia/taxonomia-animal.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/T/Taxonomia/taxonomia/taxonomia.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator responsive-img"
                 src="Hackathon/T/Termodinamica/termodinamica/20120328-funcionamiento-de-panel-termodinámico.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Termodinamica<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Termodinamica<i
                        class="material-icons right">close</i></span>
            <p>Termodinamica:La termodinámica es el estudio de la energía y su relación con otras formas de energía en
                un sistema. Existen por lo menos, tres leyes de la termodinámica. La primera ley de la termodinámica
                declara que la cantidad total de energía en un sistema, permanece constante. La segunda ley trata con el
                flujo de calor, donde el calor no puede fluir en un sistema que tenga un grado más alto de calor, a
                menos que actúe sobre este, por otra fuerza o sistema. Esta ley trata también con la entropía, donde hay
                un incremento de energía inútil, en un sistema en la medida en que la distribución se convierte
                inclusive en un sistema, y la energía no utilizable puede ser obtenida. En otras palabras, las cosas se
                deterioran/declinan. La tercera ley declara que un sistema no puede ser reducido al cero absoluto, la
                temperatura más baja posible donde el movimiento atómico se detiene.</p>
            <div class="center center-block i">
                <img src="Hackathon/T/Termodinamica/termodinamica/20120328-funcionamiento-de-panel-termodinámico.jpg"
                     alt="" class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/T/Termodinamica/termodinamica/seminario-termodinamica-4-638.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/T/Termodinamica/termodinamica/Sin%20título.png" alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <div class="card ss1">
        <div class="card-image waves-effect waves-block waves-light">
            <img class="activator  responsive-img" src="Hackathon/T/Toxina/toxina/279149-944-551.jpg">
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Toxina<i
                        class="material-icons right">more_vert</i></span>
            <p><a href="#">Ver más</a></p>
        </div>
        <div class="card-reveal black-text left-align">
            <span class="card-title grey-text text-darken-4">Toxina<i class="material-icons right">close</i></span>
            <p>La toxina es una sustancia venenosa producida por un organismo o células vivas, la cual es dañina
                a ese organismo u organismos. Una toxina no es una sustancia venenosa hecha por el hombre. Estas son
                sustancias naturales.</p>
            <div class="center center-block i">
                <img src="Hackathon/T/Toxina/toxina/279149-944-551.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/T/Toxina/toxina/descarga.jpg" alt="" class="responsive-img z-depth-3 materialboxed">
                <img src="Hackathon/T/Toxina/toxina/Clostridium%20botulinum.jpg" alt=""
                     class="responsive-img z-depth-3 materialboxed">
            </div>
        </div>
    </div>
    <?php
    $i = 0;
    $fp = fopen("../definiendo/t.txt", "r") or die('no se pudo conectar');
    while (!feof($fp)) {
        $buffer = fgets($fp, 100);
        $buf[$i] = $buffer;
        $i = $i + 1;
        ...
        <li>
            ...
            <div class="collapsible-body">
                <form action="t.php" method="post" enctype="multipart/form-data">
                    ...
                    <input type="text" name="subtitulo" placeholder="Nombre Cientifico">
